...
export default function Voluntarios() {
    ...
    //     e.preventDefault();
    //     try {
    //         const response = await axios.post('/api/voluntarios', dados);
    ...
    return (
        <div className="voluntarios-container">
            ...
            <form  className="voluntarios-form">
                ...
                <div className="form-group file-upload">
                    ...
                    <div className="file-upload-container">
                        <label htmlFor="termo" className="file-upload-label">
                            <span>{dados.termo ? 'Arquivo selecionado' : 'Selecionar arquivo'}</span>
                            <input 
                                type="file"
                                id="termo"
                                onChange={(e) => setDados({...dados, termo: e.target.files[0]?.name || ''})} 
                            />
                        </label>
                    </div>
                </div>
                ...
                <div className="form-footer">
                    ...
                    >
                        ...
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M18 13V19C18 20.1046 17.1046 21 16 21H5C3.89543 21 3 20.1046 3 19V8C3 6.89543 3.89543 6 5 6H11M15 3H21M21 3V9M21 3L10 14" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                    </a>
                </div>
            </form>
